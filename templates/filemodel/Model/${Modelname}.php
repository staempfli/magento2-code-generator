...
class ${Modelname} extends AbstractModel implements IdentityInterface
{
     ...
     * @param ${Modelname}Factory ${modelname}Factory
    ...
    public function __construct(
        ...
        ${Modelname}Factory ${modelname}Factory,
        Context $context,
        Registry $registry,
        ...
        $this->${modelname}Factory = ${modelname}Factory;
    }
    ...
    public function saveDynamicFieldFiles(array $files, array $data = [])
    {
        ...
        foreach ($files as $file) {
            ...
            $fileObject = $this->${modelname}Factory->create()->addData($file);
